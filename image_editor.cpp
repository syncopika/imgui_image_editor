...
#include <time.h> // for using with srand()
#include <GL/glew.h>
...
int main(int, char**)
{
    ...
    while(!done){
        ...
        ImGui::Begin("App", NULL, ImGuiWindowFlags_HorizontalScrollbar | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize);
